...
Si se ejecuta el programa desde Adept con el .bit no se verá nada ya que necesitamos la terminal para ejecutar la generación y adquisición de las ondas.
